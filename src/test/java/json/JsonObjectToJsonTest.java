...
public class JsonObjectToJsonTest {
    ...
    @Test
    public void testToJsonWithZeroPairs() throws Exception {// 1 test to pass
    ...
    @Test
    public void testToJsonWithOnePair() throws Exception {//2 test to pass
    ...
    @Test
    public void testToJsonWithTwoPairs() throws Exception {//3 test to pass
    ...
    @Test
    public void testToJsonPairsWithSameNamesButDifferentValues() throws Exception {//4 test to pass
        JsonObject jsonObject = new JsonObject(
